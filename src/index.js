...
export class ProgressBar {
    ...
    /** @protected */
    static _renderBar(out, label, percent, max) {
    ...
    /** @protected */
    static _renderBarSpin(out, label, percent, max, spinState) {
        out.write(AnsiCodes.clear);
        out.write(AnsiCodes.start);
